 ...
 */
public class AlbumTrackController implements Initializable {
    ...
    private void addTrack(ActionEvent event) {
        if(tfName.getText().isEmpty()) {
            ...
            track = new AlbumTrack(tfName.getText(), Integer.parseInt(tfDuration.getText()));
